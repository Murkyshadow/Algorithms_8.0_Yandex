# для начало надо распарсить строку (вытащить из нее числа и понять какое действие нужно сделать)
# далее делаем это действие, единственно подсписок всегда должен ссылаться на оригинальный список и все изменения совершаться должны только в орнигинальном списке
# даже если делаем подсписок подсписка, то все равно ссылаемся на оригинальный список (просто сдвигаем начало и конец подподсписка)
import re
