...
# далее делаем это действие, единственно подсписок всегда должен ссылаться на оригинальный список и все изменения совершаться дожны только в орнигинальном списке
