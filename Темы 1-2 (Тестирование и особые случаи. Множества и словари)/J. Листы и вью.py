...
# далее делаем это действие, единственно подсписко всегда должен ссылаться на оригинальный список и все изменения совершаться дожны только в орнигинальном списке
# даже если делаем подсписок подсписка, то все равно ссылаемся на оригинальный списко (просто сдвигаем начало и конец подподсписка)
import re
